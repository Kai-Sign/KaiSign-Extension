...
function getRuntimeFallbackDefinition(_selector, _contractAddress) {
  // All selector-specific definitions have been migrated to metadata files
  // in kaisign-backend/backend/metadata/.  When the backend serves these
  // metadata entries the decoder receives them through the normal metadata
  // pipeline and no longer needs a runtime fallback.
  return null;
}

export async function runTests(harness) {
  ...
  results.push(await harness.runTest({
    name: 'Known selector on unknown contract stays unknown without metadata',
    ...
    expected: {
      shouldSucceed: false,
      selector: '0x095ea7b3',
      intent: 'Unknown call 0x095ea7b3'
    }
  }));
  ...
  results.push(await harness.runTest({
    name: 'Known ERC-20 selector without contract metadata stays unknown',
    ...
    expected: {
      shouldSucceed: false,
      selector: '0xa9059cbb',
      intent: 'Unknown call 0xa9059cbb'
    }
  }));

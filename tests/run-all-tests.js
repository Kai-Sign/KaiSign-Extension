...
const TEST_SUITES = [
  ...
  { name: 'core/icu-select-template.test.js', path: './suites/core/icu-select-template.test.js' },
  { name: 'core/title-address-overflow.test.js', path: './suites/core/title-address-overflow.test.js' },
  { name: 'core/popup-render-pipeline.test.js', path: './suites/core/popup-render-pipeline.test.js' },
  { name: 'core/export-replay.test.js', path: './suites/core/export-replay.test.js' },
  ...
  { name: 'protocols/lifi-from-api.test.js', path: './suites/protocols/lifi-from-api.test.js' },
